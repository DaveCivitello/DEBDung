...
try(dyn.unload("IndividualModel_dung3.dll")) # unload dll
system("R CMD SHLIB IndividualModel_dung3.c")
dyn.load("IndividualModel_dung3.dll") # Load dll
...
# Split apart prior estimates of parameters into process and observation parameters so we can add the dung-related ones
process.pars = pars[1:25] # process
sd.pars = pars[26:34]     # observation

# Add dung-related process parameters
process.pars["yEF3"] = 0.35 # assimilation efficiency for Pleco only food
process.pars["yED"] = 0.07  # assimilation efficiency for dung as food
process.pars["rho"] = 1e-3 # relative palatability of dung
process.pars["kR2"] =  0.01 # Damage turnover rate for dung-damage
process.pars["mR2"] = 1e-9 # Damage repair cost for dung damage
process.pars["kk2"] = 1e-9 # How deadly is dung-damage
process.pars["d02"] = 1e2 # Threshold for death caused by dung damage

# Add dung-related observation parameters
sd.pars[c("sd.L4", "sd.E4", "sd.W4")] = c(0.1, 1, 1)

params = c(process.pars, sd.pars)



# inits = setinits.Dung(D0 = as.numeric(params["DR"]), Dung0=40)
# dung <- data.frame(lsoda(inits, 0:dur.D, func = "derivs", dllname = "IndividualModel_dung3",
#                          initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
#                          params[c(1:15, 26, 17:24, 27:32)],  rtol=1e-6, atol=1e-6,
#                          events = list(data = Dung.events(initial.food = 10, initial.dung = 40))))
# dung
# 
# par(mfrow=c(3, 3))
# plot(F ~ time, data=dung, type="l", ylab="Food abundance")
# plot(Dung ~ time, data=dung, type="l", ylab="Dung abundance")
# plot(LG ~ time, data=dung, type="l", ylim=c(0, 20), ylab="Snail shell length")
# lines(L ~ time, data=dung, col="red", lty=2, ylab="Snail shell length")
# plot(e ~ time, data=dung, type="l", ylim=c(0, 1), ylab="Snail reserve density")
# plot(RH/0.015 ~ time, data=dung, type="l", ylab="Cumulative host reproduction")
# plot(RP/4e-5 ~ time, data=dung, type="l", ylab="Cumulative cercariae release")
# plot(DAM ~ time, data=dung, type="l", ylab="Damage type 1")
# plot(DAM2 ~ time, data=dung, type="l", ylab="Damage type 2 [Dung]")
# plot(Survival ~ time, data=dung, type="l", ylim=c(0,1), ylab="Probability of host survival")
...
solve.DEB.Dung<-function(params, duration=dur.D){
  ...
  capture.output(HF_D0_U <- data.frame(lsoda(inits_U, 0:duration, func = "derivs", dllname = "IndividualModel_dung3", 
                                             initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
  ...
  capture.output(HF_D0_I <- lsoda(inits_I, 0:duration, func = "derivs", dllname = "IndividualModel_dung3", 
                                  initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                                  params,  rtol=1e-6, atol=1e-6,   
                                  events = list(data = Events_HF_D0)))
  ...
  capture.output(HF_D0.04_U <- lsoda(inits_U, 0:duration, func = "derivs", dllname = "IndividualModel_dung3", 
                                     initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                                     params,  rtol=1e-6, atol=1e-6,   
  ...
  capture.output(HF_D0.04_I <- lsoda(inits_I, 0:duration, func = "derivs", dllname = "IndividualModel_dung3", 
                                     initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                                     params,  rtol=1e-6, atol=1e-6,   
                                     events = list(data = Events_HF_D0.04)))
  ...
  capture.output(HF_D0.08_U <- lsoda(inits_U, 0:duration, func = "derivs", dllname = "IndividualModel_dung3", 
                                     initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                                     params,  rtol=1e-6, atol=1e-6,   
  ...
  capture.output(HF_D0.08_I <- lsoda(inits_I, 0:duration, func = "derivs", dllname = "IndividualModel_dung3", 
                                     initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                                     params,  rtol=1e-6, atol=1e-6,   
                                     events = list(data = Events_HF_D0.08)))
  ...
  capture.output(HF_D0.12_U <- lsoda(inits_U, 0:duration, func = "derivs", dllname = "IndividualModel_dung3", 
                                     initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                                     params,  rtol=1e-6, atol=1e-6,   
  ...
  capture.output(HF_D0.12_I <- lsoda(inits_I, 0:duration, func = "derivs", dllname = "IndividualModel_dung3", 
                                     initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                                     params,  rtol=1e-6, atol=1e-6,   
                                     events = list(data = Events_HF_D0.12)))
  ...
  capture.output(HF_D0.16_U <- lsoda(inits_U, 0:duration, func = "derivs", dllname = "IndividualModel_dung3", 
                                     initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                                     params,  rtol=1e-6, atol=1e-6,   
  ...
  capture.output(HF_D0.16_I <- lsoda(inits_I, 0:duration, func = "derivs", dllname = "IndividualModel_dung3", 
                                     initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                                     params,  rtol=1e-6, atol=1e-6,   
                                     events = list(data = Events_HF_D0.16)))
  ...
  capture.output(HF_D0.20_U <- lsoda(inits_U, 0:duration, func = "derivs", dllname = "IndividualModel_dung3", 
                                     initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                                     params,  rtol=1e-6, atol=1e-6,   
  ...
  capture.output(HF_D0.20_I <- lsoda(inits_I, 0:duration, func = "derivs", dllname = "IndividualModel_dung3", 
                                     initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                                     params,  rtol=1e-6, atol=1e-6,   
                                     events = list(data = Events_HF_D0.20)))
  ...
  capture.output(LF_D0_U <- lsoda(inits_U, 0:duration, func = "derivs", dllname = "IndividualModel_dung3", 
                                  initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                                  params,  rtol=1e-6, atol=1e-6,   
  ...
  capture.output(LF_D0_I <- lsoda(inits_I, 0:duration, func = "derivs", dllname = "IndividualModel_dung3", 
                                  initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                                  params,  rtol=1e-6, atol=1e-6,   
                                  events = list(data = Events_LF_D0)))
  ...
  capture.output(LF_D0.04_U <- lsoda(inits_U, 0:duration, func = "derivs", dllname = "IndividualModel_dung3", 
                                     initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                                     params,  rtol=1e-6, atol=1e-6,   
  ...
  capture.output(LF_D0.04_I <- lsoda(inits_I, 0:duration, func = "derivs", dllname = "IndividualModel_dung3", 
                                     initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                                     params,  rtol=1e-6, atol=1e-6,   
                                     events = list(data = Events_LF_D0.04)))
  ...
  capture.output(LF_D0.08_U <- lsoda(inits_U, 0:duration, func = "derivs", dllname = "IndividualModel_dung3", 
                                     initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                                     params,  rtol=1e-6, atol=1e-6,   
  ...
  capture.output(LF_D0.08_I <- lsoda(inits_I, 0:duration, func = "derivs", dllname = "IndividualModel_dung3", 
                                     initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                                     params,  rtol=1e-6, atol=1e-6,   
                                     events = list(data = Events_LF_D0.08)))
  ...
  capture.output(LF_D0.12_U <- lsoda(inits_U, 0:duration, func = "derivs", dllname = "IndividualModel_dung3", 
                                     initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                                     params,  rtol=1e-6, atol=1e-6,   
  ...
  capture.output(LF_D0.12_I <- lsoda(inits_I, 0:duration, func = "derivs", dllname = "IndividualModel_dung3", 
                                     initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                                     params,  rtol=1e-6, atol=1e-6,   
                                     events = list(data = Events_LF_D0.12)))
  ...
  capture.output(LF_D0.16_U <- lsoda(inits_U, 0:duration, func = "derivs", dllname = "IndividualModel_dung3", 
                                     initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                                     params,  rtol=1e-6, atol=1e-6,   
  ...
  capture.output(LF_D0.16_I <- lsoda(inits_I, 0:duration, func = "derivs", dllname = "IndividualModel_dung3", 
                                     initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                                     params,  rtol=1e-6, atol=1e-6,   
                                     events = list(data = Events_LF_D0.16)))
  ...
  capture.output(LF_D0.20_U <- lsoda(inits_U, 0:duration, func = "derivs", dllname = "IndividualModel_dung3", 
                                     initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                                     params,  rtol=1e-6, atol=1e-6,   
  ...
  capture.output(LF_D0.20_I <- lsoda(inits_I, 0:duration, func = "derivs", dllname = "IndividualModel_dung3", 
                                     initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                                     params,  rtol=1e-6, atol=1e-6,   
                                     events = list(data = Events_LF_D0.20)))
  ...
  prior.lik = with(as.list(p),
                   sum(dbeta(c(yPE, yEF, yEF2, yEF3, yED, yRP, yVE, mP, eh, k, fe), 1, 1, log=T)) + 
                     ...
                     sum(dunif(c(ph, alpha, iPM, EM, DR, Fh, muD, kR, delta0, hdelta, theta, mR, hb, 
                                 rho, kR2, mR2, kk2, d02), min=0, max=1000000, log=T)) +
...
DEB_parameter_trans = function(x){
  log_par_names = c("ph", "alpha", "iPM", "EM", "DR", "Fh", "muD", "kR", "delta0", "hdelta", "theta", "mR", "hb", "rho", "kR2", "mR2", "kk2", "d02")
...
# Compare outputs of objective functions with transformed vs. not parameters
params
b = DEB_parameter_backtrans(params)

# Prior likelihood function gives same results
prior.likelihood.trans(b)
prior.likelihood(params)

# Full likelihood function gives same results - check fully passed
full.likelihood(params)
full.likelihood.trans(b)
### Tuning ###
...
# Needed these to kickstart things when first implementing log-transform
#backtrans.pars = DEB_parameter_backtrans(pars) 
#variances = diag(length(backtrans.pars))*0.000001

model_fit = MCMC(full.likelihood.trans, init=pars, scale=as.matrix(variances), adapt=5000, acc.rate = 0.3, n=5000)
