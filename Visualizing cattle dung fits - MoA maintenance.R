...
try(dyn.unload("DEBDung_MoA_maintenance.so")) # unload dll
system("R CMD SHLIB DEBDung_MoA_maintenance.c")
dyn.load("DEBDung_MoA_maintenance.so") # Load dll
...
DEB_dung_vis = function(pars){
  ...
  dung0 <- data.frame(lsoda(inits, 0:dur.D, func = "derivs", dllname = "DEBDung_MoA_maintenance",
  ...
  dung40 <- data.frame(lsoda(inits, 0:dur.D, func = "derivs", dllname = "DEBDung_MoA_maintenance",
                              initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                              params.t[1:34],  rtol=1e-6, atol=1e-6,
                              events = list(data = Dung.events(initial.food = 10.76, initial.dung = as.numeric(inits["Dung"])))))
  dung40
  ...
  dung80 <- data.frame(lsoda(inits, 0:dur.D, func = "derivs", dllname = "DEBDung_MoA_maintenance",
                              initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                              params.t[1:34],  rtol=1e-6, atol=1e-6,
                              events = list(data = Dung.events(initial.food = 10.76, initial.dung = as.numeric(inits["Dung"])))))
  dung80
  ...
  dung120 <- data.frame(lsoda(inits, 0:dur.D, func = "derivs", dllname = "DEBDung_MoA_maintenance",
                              initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                              params.t[1:34],  rtol=1e-6, atol=1e-6,
                              events = list(data = Dung.events(initial.food = 10.76, initial.dung = as.numeric(inits["Dung"])))))
  dung120
  ...
  dung160 <- data.frame(lsoda(inits, 0:dur.D, func = "derivs", dllname = "DEBDung_MoA_maintenance",
                              initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                              params.t[1:34],  rtol=1e-6, atol=1e-6,
                              events = list(data = Dung.events(initial.food = 10.76, initial.dung = as.numeric(inits["Dung"])))))
  dung160
  ...
  dung200 <- data.frame(lsoda(inits, 0:dur.D, func = "derivs", dllname = "DEBDung_MoA_maintenance",
                           initfunc = "initmod",  nout=2, outnames=c("Survival", "LG"), maxsteps=5e5,
                           params.t[1:34],  rtol=1e-6, atol=1e-6,
                           events = list(data = Dung.events(initial.food = 10.76, initial.dung = as.numeric(inits["Dung"])))))
  dung200
